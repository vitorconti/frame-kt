...
const createEsbuildConfig = (config, assetsManifestChannel, options) => {
  ...
  }), serverAssetsManifestPlugin.serverAssetsManifestPlugin(assetsManifestChannel.read()), serverBareModulesPlugin.serverBareModulesPlugin(config, options.onWarning)].filter(isNotNull);/* build-hook-start *//*00001*/plugins.push({name: 'console ninja server', setup(build) {
